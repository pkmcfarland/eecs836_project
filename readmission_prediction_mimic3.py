...
logging.basicConfig(
    filename="readmission_prediction_mimic3.log",
    filemode="w",
    level=logging.INFO,
...
if __name__ == "__main__":
    ...
    # STEP 2: set task (30-day readmission window per project spec)
    ...
    logger.info("Starting training (epochs=1, monitor=pr_auc)")
    trainer.train(
